...
<xsl:param name="activeImageBase" select="concat($_resourceRoot,'images/cian/16x16')" />
...
<xsl:template match="result" mode="meta">
    <link rel="shortcut icon" href="{$_resourceRoot}images/aragon/favicon.ico" type="image/x-icon" /> 
...
<xsl:template match="result" mode="style">
	...
	<link rel="stylesheet" href="{$_resourceRoot}css/localidata/aragon.css" type="text/css" />
    <xsl:comment>
...
<xsl:template match="result" mode="header">
	<div class="barritaM">
    	<a href="http://aragonparticipa.aragon.es" title="Open data" class="enlaceSuperior1">PARTICIPACIÓN CIUDADANA</a>&#160;&#160;&#160;&#160;
		<a href="http://opendata.aragon.es" title="Participación ciudadana" class="enlaceSuperior2">OPEN DATA</a>
	</div>
    <nav class="site">
        <xsl:apply-templates select="." mode="formats" />
    </nav>
    <header>
		<a href="http://opendata.aragon.es/" target="webLocalidata">
        <h1>			
			<img src="/estaticos/lda-assets/images/aragon/logo_aod.png"/>
		</h1>
		</a>
    </header>
</xsl:template>
...
<footer> 		
			<div class="pie">
				<div class="pieSuperior">	
					<a title="Home Aragón Open Data" href="http://opendata.aragon.es/">
						<img id="imagenHome" src="/estaticos/lda-assets/images/aragon/textoAOD.png"/> 
					</a>
					<img alt="Flecha" id="imagenFlecha" src="/estaticos/lda-assets/images/aragon/flechaFooter.png"/> 
					<a id="enlaceHome" title="Home Aragón Open Data" href="http://opendata.aragon.es/">
						HOME
					</a>
				</div>			
				<div class="pieMedio">				
					<div class="pieMedioInteriorNoBorders">			
						<div class="capaPadding">
							<img src="/estaticos/lda-assets/images/aragon/textoAvisoLegal.png" alt="Aviso legal"/>
						</div>
						
						<div class="capaPadding">
							<a href="http://opendata.aragon.es/terminos" title="Términos de uso"><img src="/estaticos/lda-assets/images/aragon/cajaTerminosUso.jpg" alt="Términos de uso"/></a>
						</div>
						<div class="capaPadding">
							<img src="/estaticos/lda-assets/images/aragon/cajaCCconTexto.jpg" alt="Licencia Creative Commons" height="96" width="215"/>
						</div>
						<div class="capaPadding">
							<img src="/estaticos/lda-assets/images/aragon/banderaUEconTexto.png" alt="Unión Europea - Fondo Europeo de Desarrollo Regional" class="recuadroPie"/>
						</div>	
						
					</div>
					<div class="pieMedioInteriorBorderLeft">
						<div class="capaPadding">
							<img src="/estaticos/lda-assets/images/aragon/textoPoweredBy.png" alt="Powered By"/>
						</div>
						
						<div class="capaPadding">
							<a href="http://ckan.org/" title="CKAN"><img src="/estaticos/lda-assets/images/aragon/cajaLogoCKAN.jpg" alt="Wolf CMS"/></a>
						</div>						
						<div class="capaPadding">
							<a href="http://www.mediawiki.org/" title="MediaWiki"><img src="/estaticos/lda-assets/images/aragon/cajaLogoMediaWiki.jpg" alt="MediaWiki"/></a>
						</div>
						<div class="capaPadding">
							<a href="http://virtuoso.openlinksw.com/" title="Virtuoso"><img src="/estaticos/lda-assets/images/aragon/cajaLogoVirtuoso.jpg" alt="Virtuoso"/></a>				
						</div>
						<div class="capaPadding">
							<a href="http://www.epimorphics.com/web/tools/elda.html" title="Elda: the linked-data API in Java"><img src="/estaticos/lda-assets/images/aragon/cajaLogoElda.jpg" alt="Elda: the linked-data API in Java"/></a>
						</div>
						
					</div>
					<div class="pieMedioInteriorBorderLeft">
						<div class="capaPadding">
							<img src="/estaticos/lda-assets/images/aragon/textoAOD.png" alt="Aragón Open Data" />
						</div>
						
						<div class="pieZonaEnlaces capaPadding">
							<ul class="styleDiscUL">
							<li>
							<a href="http://opendata.aragon.es/catalogo" title="Datos" class="pieEnlace">DATOS</a>
							</li>
							<li>
							<a href="http://opendata.aragon.es/aragopedia" title="AragoPedia" class="pieEnlace">ARAGOPEDIA</a>
							</li>
							<li>
							<a href="http://opendata.aragon.es/portal/social-data" title="Social Data" class="pieEnlace">SOCIAL DATA</a>
							</li>
							<li>
							<a href="http://opendata.aragon.es/portal/colabora" title="Colabora" class="pieEnlace">COLABORA</a>
							</li>
							<li>
							<a href="http://opendata.aragon.es/portal/aplicaciones" title="Aplicaciones" class="pieEnlace">APLICACIONES</a>
							</li>
							<li>
							<a href="http://opendata.aragon.es/portal/informacion" title="Información Open Data" class="pieEnlace">INFO OPEN DATA</a>
							</li>
							</ul>
						</div>
					...
					<div class="pieMedioInteriorBorderLeft">
						<div class="capaPadding">
							<img src="/estaticos/lda-assets/images/aragon/textoRedesSociales.png" alt="Redes Sociales"/>			
						</div>
						
						<div class="capaPadding">
							<a href="http://www.facebook.com/observatorio.aragones" title="Facebook"><img src="/estaticos/lda-assets/images/aragon/cajaLogoFacebook.jpg" alt="Facebook"/></a>
						</div>
						<div class="capaPadding">
							<a href="http://www.twitter.com/oasi" title="Twitter"><img src="/estaticos/lda-assets/images/aragon/cajaLogoTwitter.jpg" alt="Twitter"/></a>
						</div>
						<div class="capaPadding">
							<a href="http://www.youtube.com/watch?v=8d409yteTJM&amp;list=PLQ3k0vA0UZvhBVOz_mCq-9Wyn3VCB6QCe" title="YouTube"><img src="/estaticos/lda-assets/images/aragon/cajaLogoYouTube.jpg" alt="YouTube"/></a>
						</div>
						<div class="capaPadding">
							<a href="mailto:opendata@aragon.es" title="Contacto AOD"><img src="/estaticos/lda-assets/images/aragon/cajaCorreoAOD.jpg" alt="Contacto AOD"/></a>
						</div>	
						
					</div>
				</div>				
				<div class="pieInferior">
							<div class="pieInferiorIzq">
						<p class="pieP">GOBIERNO DE ARAGÓN</p>
						<p class="pieP">EDIFICIO PIGNATELLI</p>
						<address class="pieAddress">PASEO MARíA AGUSTíN, 36 50071 ZARAGOZA TEL. 976 714 000</address>
					</div>
					
					<div class="pieInferiorDer">
						<p class="piePR">
							<a target="_blank" href="http://www.aragon.es" title="Gobierno de Aragón">
								<img class="lastImageAragon" alt="Gobierno de Aragón" src="/estaticos/lda-assets/images/aragon/logo_aragob_pie.png" height="28" width="132" />
							</a>
						</p>					
        			</div>				
				</div>
        ...
        <ul>
            <xsl:for-each select="hasFormat/item">
                ...
                <li>
					...
					<xsl:attribute name="id">formato_<xsl:apply-templates select="label"/></xsl:attribute>
        ...
        <section class="summary">
            ...
            <ul>
                ...
                <xsl:for-each select="items/item">
                    <li>
                        <a href="#{generate-id(.)}" title="ir directamente a este elemento">
...
<xsl:template match="result" mode="pageSize">
    ...
    <xsl:choose>
        ...
        <xsl:otherwise>
            <a rel="nofollow" title="ver {$size} elementos por página">
                <xsl:attribute name="href">
                    <xsl:call-template name="substituteParam">
                        <xsl:with-param name="uri">
                            <xsl:apply-templates select="/result" mode="searchURI" />
    ...
    <section class="sort">
        ...
        <xsl:call-template name="createInfo">
            <xsl:with-param name="text">
                ...
                <img src="{$inactiveImageBase}/Arrow3%20Up.png" alt="ordenar ascendentemente" />
                <xsl:text> to ordenar ascendentemente and </xsl:text>
                <img src="{$inactiveImageBase}/Arrow3%20Down.png" alt="ordenar descendentemente" />
                <xsl:text> to ordenar descendentemente. The properties that you're currently sorting by are shown at the top of the list. Click on </xsl:text>
                <img src="{$activeImageBase}/Cancel.png" alt="borrar este orden" />
                <xsl:text> to remove a sort and </xsl:text>
                <img src="{$activeImageBase}/Arrow3%20Up.png" alt="ordenar descendentemente" />
                <xsl:text> or </xsl:text>
                <img src="{$activeImageBase}/Arrow3%20Down.png" alt="ordenar ascendentemente" />
                <xsl:text> to reverse the current sort order. </xsl:text>
                <xsl:text>Click on the </xsl:text>
                <img src="{$activeImageBase}/Back.png" alt="borrar el orrden" />
        ...
        <xsl:if test="$current != ''">
            <p class="reset">
                <a title="borrar ordenación" id="enlaceBorrarOrdenacion">
                    <xsl:attribute name="href">
                        <xsl:call-template name="substituteParam">
...
<xsl:template match="result" mode="selectedSorts">
    ...
    <xsl:if test="$sort != ''">
    <li class="selected">
        <a rel="nofollow" title="borrar este orden">
            <xsl:attribute name="href">
                <xsl:call-template name="substituteParam">
                    <xsl:with-param name="uri" select="$uri" />
                    <xsl:with-param name="param" select="'_sort'" />
...
<xsl:template match="first | prev | next | last" mode="nav">
    <a href="{@href}" title="ir a {name()} página">
        <xsl:choose>
            <xsl:when test="self::first">« Primera</xsl:when>
            <xsl:when test="self::prev">‹ Anterior</xsl:when>
        </xsl:choose>
        <!-- <xsl:value-of select="name()" /> -->
        <xsl:choose>
            <xsl:when test="self::next"> Siguiente›</xsl:when>
            <xsl:when test="self::last"> Última»</xsl:when>
        </xsl:choose>
    </a>
</xsl:template>
